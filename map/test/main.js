...
}).setView([39.21751555999993,109.06017016000008], 5);
	...
	$.ajax({
		...
		success: function(data){
			for (var i = 0;i < data.features.length;i++){
				...
				if (property.Status == 1){
					if (property.Type == 1)
						markers[i]._icon.src = 'images/generator1.png';
					else{
						markers[i]._icon.src = 'images/bus1.png';
					}
				}
				else{
					if (property.Type == 1)
						markers[i]._icon.src = 'images/generator2.png';
					else{
						markers[i]._icon.src = 'images/bus2.png';
					}
				}
				if (property.attacked == 1){
					if (property.Type == 1){
						var color = 'images/attack04.png';
					}
					else{
						var color = 'images/attack004.png';
					}
